  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex place-content-center">
        <div className="w-8/12 h-[648px] flex place-content-center justify-between items-center">
          {/* LAYER 1 */}
          <div className="flex flex-col items-center text-center gap-2">
            <img src={w_blue} alt="" className="h-14 w-14" />
            <h1
              className="font-poppins font-bold text-6xl mb-11 justify-center "
              style={{ color: "#7181A7" }}
            >
              About Us
            </h1>
            ...
            >
              ...
              and we’re constantly innovating to bring you more. <br />
              <br />
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mx-[80px]">
          ...
          <p className="font-poppins text-xl" style={{ color: "#7181A7" }}>
            To transform everyday hydration into a healthy, enjoyable experience
            by delivering vitamin-infused water packed with natural flavors. At
            Water-up, we aim to make staying hydrated effortless and delightful,
            helping individuals live healthier and more vibrant lives, one sip
            at a time.
          </p>
        </div>
        <div className="flex flex-col items-center text-center mx-[80px]">
          ...
          <p className="font-poppins text-xl" style={{ color: "#7181A7" }}>
            To become the leading choice for health-conscious hydration,
            inspiring a global shift toward more nutritious and flavorful
            drinking options. We strive to innovate continuously, offering
            sustainable, eco-friendly products that elevate both personal
